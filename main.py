...
def draw_grid(surface, grid):
    ...
    for i in range(len(grid)):
        pygame.draw.line(surface,(100, 200, 100), (sx, sy + i * block_size), (sx + play_width, sy + i * block_size))
        for j in range(len(grid[i])):
            pygame.draw.line(surface, (100, 200, 100), (sx + j * block_size, sy), (sx + i * block_size, sy + play_height))
